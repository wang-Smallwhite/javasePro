...
public class Test2 {
  public static void main(String[] args) throws IOException {
    File f = new File("day10-file\\src\\data.txt");
    // a.创建新文件，创建成功返回true ,反之 ,不需要这个，以后文件写出去的时候都会自动创建
    System.out.println(f.createNewFile());
    File f1 = new File("day10-file\\src\\data02.txt");
    System.out.println(f1.createNewFile()); // （几乎不用的，因为以后文件都是自动创建的！）
    // b.mkdir创建一级目录
    File f2 = new File("D:/resources");
...
//        System.out.println(f3.mkdir());
    ...
    // 只能删除空文件夹,不能删除非空文件夹.
    File f5 = new File("D:/resources/ccc/ddd/eee/ffff");
